...
% data integration
The integration of open data that presented here led to new syntheses and hypotheses. 
...
Multiple data types and data structures across disciplines pose challenges in their interpretation \parencite{Enquist_2024}.
Their combination allows for identifying sampling biases and gaps. 
Integrated data offer a snapshot of the current state of knowledge,
...
IUCN also doesn't provide raw occurrances from the assessments for most species, 
with birds being totally absent from open redlist data.
In addition, soil microbiome works, e.g \textcite{bekris2019do-genetic}, that 
provide novel information about microbes and protected areas are not 
uploaded to ENA database.

The soil microbiome assessments, along with a large catalogue of previous work on Crete 
showed vulnerable areas and potential pathogen hotspots like Richtis gorge.
